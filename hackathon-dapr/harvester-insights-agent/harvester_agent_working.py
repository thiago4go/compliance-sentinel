...
try:
    ...
    # Skip MCP import for now - it's causing issues
...
async def health_check():
    ...
    components = {
        ...
        "dapr_sidecar": "✅ Connected" if harvester_agent.dapr_client else "❌ Not Connected"
    }
...
async def agent_info():
    ...
    return {
        ...
        "components": {
            ...
            "dapr_connected": bool(harvester_agent.dapr_client)
        }
    }
